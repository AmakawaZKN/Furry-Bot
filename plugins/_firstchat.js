...
*Powered By @${global.owner[1].split('@')[0]}*`
    ...
        await conn.send3ButtonLoc(m.chat, 'https://telegra.ph/file/9600fa4dda16a92ecb644.jpg', ` ${ucapan()}, @${m.sender.split`@`[0]}
 ${user.banned ? 'kamu dibanned' : `
Saya Adalah Amakawa Zy, Bot WhatsApp Yang Bisa Anda Gunakan Untuk Membuat Sticker, Mendownload Sesuatu, Bermain Game, Dll.
